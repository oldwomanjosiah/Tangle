...
dependencies {
  ...
  dependencySync("androidx.appcompat:appcompat:1.4.1")
  dependencySync("androidx.arch.core:core-testing:2.1.0")
  dependencySync("androidx.compose.compiler:compiler:1.1.0-rc02")
  dependencySync("androidx.compose.foundation:foundation:1.1.0-rc01")
  dependencySync("androidx.compose.material:material-icons-core:1.1.0-rc01")
  dependencySync("androidx.compose.material:material-icons-extended:1.1.0-rc01")
  dependencySync("androidx.compose.material:material:1.1.0-rc01")
  dependencySync("androidx.compose.runtime:runtime:1.1.0-rc01")
  dependencySync("androidx.compose.ui:ui-test-junit4:1.1.0-rc01")
  dependencySync("androidx.compose.ui:ui-test-manifest:1.1.0-rc01")
  dependencySync("androidx.compose.ui:ui-tooling:1.1.0-rc01")
  dependencySync("androidx.compose.ui:ui:1.1.0-rc01")
  dependencySync("androidx.constraintlayout:constraintlayout:2.1.3")
  dependencySync("androidx.core:core-ktx:1.7.0")
  dependencySync("androidx.fragment:fragment-ktx:1.4.1")
  dependencySync("androidx.fragment:fragment-testing:1.4.1")
  dependencySync("androidx.fragment:fragment:1.4.1")
  dependencySync("androidx.lifecycle:lifecycle-common:2.4.0")
  dependencySync("androidx.lifecycle:lifecycle-livedata-core:2.4.0")
  dependencySync("androidx.lifecycle:lifecycle-livedata-ktx:2.4.0")
  dependencySync("androidx.lifecycle:lifecycle-runtime-ktx:2.4.0")
  dependencySync("androidx.lifecycle:lifecycle-runtime:2.4.0")
  ...
  dependencySync("androidx.lifecycle:lifecycle-viewmodel-savedstate:2.4.0")
  dependencySync("androidx.lifecycle:lifecycle-viewmodel:2.4.0")
  dependencySync("androidx.navigation:navigation-common:2.4.0")
  dependencySync("androidx.navigation:navigation-compose:2.4.0")
  dependencySync("androidx.navigation:navigation-fragment-ktx:2.4.0")
  dependencySync("androidx.navigation:navigation-runtime-ktx:2.4.0")
  dependencySync("androidx.navigation:navigation-ui-ktx:2.4.0")
  dependencySync("androidx.paging:paging-common-ktx:3.1.0")
  dependencySync("androidx.paging:paging-compose:1.0.0-alpha14")
  dependencySync("androidx.paging:paging-runtime-ktx:3.1.0")
  dependencySync("androidx.room:room-common:2.4.1")
  dependencySync("androidx.room:room-compiler:2.4.1")
  dependencySync("androidx.room:room-ktx:2.4.1")
  dependencySync("androidx.room:room-paging:2.4.1")
  dependencySync("androidx.room:room-runtime:2.4.1")
  dependencySync("androidx.room:room-testing:2.4.1")
  ...
  dependencySync("androidx.test:orchestrator:1.4.1")
  dependencySync("androidx.test:rules:1.4.1")
  dependencySync("androidx.test:runner:1.4.1")
  dependencySync("androidx.work:work-runtime-ktx:2.7.1")
  dependencySync("androidx.work:work-runtime:2.7.1")
  dependencySync("androidx.work:work-testing:2.7.1")

  dependencySync("com.android.tools.build:gradle:7.1.0")
  ...
  dependencySync("com.google.android.material:material:1.5.0")
  dependencySync("com.google.auto.service:auto-service-annotations:1.0.1")
  dependencySync("com.google.auto.service:auto-service:1.0.1")
  ...
  dependencySync("com.squareup.moshi:moshi-kotlin:1.13.0")
  ...
  dependencySync("com.google.devtools.ksp:symbol-processing-gradle-plugin:1.6.10-1.0.2")
  ...
  dependencySync("com.google.dagger:hilt-android-compiler:2.40.5")
  dependencySync("com.google.dagger:hilt-android-gradle-plugin:2.40.5")
  dependencySync("com.google.dagger:hilt-android:2.40.5")
  dependencySync("com.google.dagger:hilt-android-testing:2.40.5")
  dependencySync("androidx.hilt:hilt-navigation-compose:1.0.0")
  dependencySync("dev.zacsweers.autoservice:auto-service-ksp:1.0.0")
  dependencySync("dev.zacsweers.moshix:moshi-sealed-codegen:0.16.6")
  dependencySync("dev.zacsweers.moshix:moshi-sealed-runtime:0.16.6")
  ...
  dependencySync("io.kotest:kotest-assertions-shared-jvm:5.1.0")
  dependencySync("io.kotest:kotest-common-jvm:5.1.0")
  dependencySync("io.kotest:kotest-property-jvm:5.1.0")
  dependencySync("io.kotest:kotest-runner-junit5-jvm:5.1.0")
  dependencySync("io.mockk:mockk:1.12.2")
  ...
  dependencySync("org.jetbrains.kotlinx:kotlinx-knit:0.16.3")
  ...
  dependencySync("org.junit.jupiter:junit-jupiter:5.8.2")
  dependencySync("org.junit.vintage:junit-vintage-engine:5.8.2")
